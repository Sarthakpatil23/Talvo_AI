...
urlpatterns = [
    ...
    path('placement-hub/', views.placement_hub, name='placement_hub'),
    path('placement-hub/company/', views.placement_company, name='placement_company'),
    path('placement-hub/aptitude/', views.aptitude_round, name='aptitude_round'),
    path('placement-hub/resources/', views.company_resources, name='company_resources'),
    path('api/placement-hub/aptitude/coach/', views.aptitude_coach_api, name='aptitude_coach_api'),
    ...
    path('api/live-interview/coding/question/', views.live_interview_coding_question_api, name='live_interview_coding_question_api'),
    path('api/live-interview/coding/evaluate/', views.live_interview_coding_evaluate_api, name='live_interview_coding_evaluate_api'),
